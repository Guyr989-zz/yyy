...
$(document).ready(function () {
    ...
    //if (screen.width > 768) {
    //    var maxHeight = 0;
    //    $(".top_side .solutions h3.desktop-only").each(function (index) {
    //        if ($(this).height() > maxHeight) {

    //            maxHeight = $(this).height();
    //        }
    //        $(".top_side .solutions h3.desktop-only").height(maxHeight);
    //    });
    //    var maxHeight3 = 0;
    //    $(".top_side .solutions .text").each(function (index) {
    //        if ($(this).height() > maxHeight3) {

    //            maxHeight3 = $(this).height();
    //        }
    //        $(".top_side .solutions .text").height(maxHeight3);
    //    });


    //    var maxHeight2 = 0;
    //    $(".top_side .solutions > div").each(function (index) {
    //        if ($(this).height() > maxHeight2) {

    //            maxHeight2 = $(this).height();
    //        }
    //        $(".top_side .solutions > div").height(maxHeight2);
    //    });
    //}
